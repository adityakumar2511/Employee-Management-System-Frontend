...
export default function TopBar({ title }) {
  ...
  // ✅ user display name — multiple fallbacks
  const displayName = user?.name || user?.employeeId || user?.email || "User"
    ...
    <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b bg-background/95 backdrop-blur-sm px-5 gap-4">
      ...
      <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-muted-foreground mt-0.5">
                            {n.createdAt
                              ? dayjs(n.createdAt.toDate?.() || n.createdAt).fromNow()
                              : ""}
                          </p>
                        </div>
                        {!n.read && (
        ...
        >
          ...
          {/* ✅ logout — router.push nahi, authStore khud redirect karta hai */}
